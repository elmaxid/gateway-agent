...
endpoints OpenAI-compatibles). No es un servidor MCP: es un comando de shell normal, invocalo con la
tool de shell como cualquier otro binario.
...
Correr este CLI desde dentro de una sesión de Codex agrega una capa de sandbox entre vos y el
